package com.mobi.efficacious.TraffordSchool.FCMServices;
...
import com.mobi.efficacious.TraffordSchool.activity.IndividualChat;
import com.mobi.efficacious.TraffordSchool.activity.MainActivity;
import com.mobi.efficacious.TraffordSchool.activity.MessageCenterActivity;
import com.mobi.efficacious.TraffordSchool.activity.NoticeboardActivity;
import com.mobi.efficacious.TraffordSchool.activity.Notifiacton;
...
String Standard_id,Division_id,title;
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.e("dataChat", remoteMessage.getData().toString());
        {
            ...
            if(!title.contentEquals("Trafford School") && !title.contentEquals("Group")) {
                sendNotification("Message Center", message);
            }else if (!title.contentEquals("IndividualChat") && !title.contentEquals("Group"))
            {
                sendNotification(title,
                        message);
            }
