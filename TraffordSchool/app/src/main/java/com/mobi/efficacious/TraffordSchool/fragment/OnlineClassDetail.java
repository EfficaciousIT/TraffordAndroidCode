...
public class OnlineClassDetail extends Fragment {
    ...
    public void OnlineClassDetailAsync() {
        try {
            ...
            if (role_id.contentEquals("1") || role_id.contentEquals("2")) {
                call = service.getOnlineClassDetails("StudentNotification", teacher_Id, academic_id, Schooli_id, intStandard_id);
            }
            // Admin
            else if(role_id.contentEquals("5")){
                call = service.getOnlineClassDetails("AdminNotification", teacher_Id, academic_id, Schooli_id, intStandard_id);
            }
            //Teachers
            else if(role_id.contentEquals("3")){
                call = service.getOnlineClassDetails("TeacherNotification", teacher_Id, academic_id, Schooli_id, intStandard_id);
            }
